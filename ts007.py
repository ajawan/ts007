...
logo='''
\033[1;94m ┈┈┈┈╱▔▔▔▔╲┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈╱▔▔▔▔╲┈┈┈┈
\033[1;94m ┈┈┈▕▕AJ AJ▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕AJ AJ▏▏┈┈┈
\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈
\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mAjAwanAjAwan.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈
\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈
\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲
\033[1;96m................\033[1;93mAhmadxSharry\033[1;91m...............
\033[1;96m................\033[1;93m✬🄵🄰🄲🄴🄱🄾🄾🄺✬\033[1;91m..............

\033[1;96m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

\033[1;91m☞ Auther     : AJ-AWAN
\033[1;92m☞ WhatsApp   : 03187547003
\033[1;95m☞ Fb         : https://mbasic.facebook.com/arooj.awan.7359
...
def login():
	...
	try:
		...
		if 'access_token' in z:
		    ...
		    os.system('xdg-open https://mbasic.facebook.com/arooj.awan.7359')
		    menu()
		else:
...
def menu():
	...
	print (S + 50*'-')
	print
	print (S + '[' + P + '☞1' + S + ']' + S + ' PUBLIC ID CHUTI KR')
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update AJ-AWAN Tool')
	print (S + '[' + P + '☞3' + S + ']' + S + ' AJ-AWAN WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/AJ-AWAN')
	    os.system('cd $HOME && git clone https://github.com/ajawan/ts007.git')
	    cb()
	    print (logo)
	    psb('☆10%')
	    psb('☆☆20%')
	    ...
	    psb('Congratulations AJ_AWAN Tool Has Been Updated Successfully')
	    psb('🔓User Name☆ 777777✓')
	    psb('🔓Password ☆ 777777✓')
	    psb('muneeb janu command nhi di thi✓')
	    psb('Please Login Again')
	    time.sleep(2)
	    os.system('cd $HOME/aj_awan && python2 ts007.py')
	elif bm =='3':
	    os.system('xdg-open https://mbasic.facebook.com/arooj.awan.7359')
	    menu()
	elif bm =='4':
...
def pak():
	...
	print (S + '[' + P + '☞2' + S + ']' + P + ' Public id daal kid')
	print (S + '[' + Y + '☞3' + S + ']' + Y + ' file')
